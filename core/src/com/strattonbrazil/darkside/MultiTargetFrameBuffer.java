// stolen from https://raw.githubusercontent.com/code-disaster/libgdx-snippets/master/src/main/java/com/badlogic/gdx/graphics/glutils/MultiTargetFrameBuffer.java
...
import static com.strattonbrazil.darkside.GL33Ext.GL_CLAMP_TO_BORDER;
import static com.strattonbrazil.darkside.GL33Ext.GL_TEXTURE_BORDER_COLOR;
import com.badlogic.gdx.graphics.glutils.FrameBuffer;
import static com.badlogic.gdx.graphics.glutils.FrameBuffer.unbind;
import com.badlogic.gdx.graphics.glutils.GLFrameBuffer;
import com.badlogic.gdx.graphics.glutils.GLOnlyTextureData;
import com.strattonbrazil.darkside.MultiTargetFrameBuffer.Format;
...
public class MultiTargetFrameBuffer extends GLFrameBuffer<Texture> {
	...
	private void build(boolean hasDepth, boolean hasStencil) {
		...
		for (int i = 1; i < numColorAttachments; i++) {
			colorTextures[i] = createColorTexture(i);
                        System.out.println(colorTextures[i].getTextureObjectHandle());
	...
	private static class ColorBufferTextureData implements TextureData {
		...
		public void consumeCustomData(int target) {
                    ...
                    System.out.println(format.internal);
